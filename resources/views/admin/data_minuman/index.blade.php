...
@section('content')
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="/admin/data-minuman/create" class="btn btn-primary">Tambah Data</a>
    </div>
            ...
            @foreach($data as $data)
                <tbody>
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage/' . $data->img) }}" alt="gambar-{{ $data->nama_minuman }}" style="width: 150px; height: 150px">
                        </td>
                        <td>{{ $data->harga }}</td>
                        <td class="text-center" width=10>
                            <div class="">
                                <a href="/admin/data-minuman/{{ $data->id }}/edit"><i class="fa-solid fa-pen-to-square"></i>edit</a></td>
                            </div>
                        </td>
                        <td class="text-center" width=10>
                            <form action="/admin/data-minuman/{{ $data->id }}" method="post">
                                @csrf
                                @method('delete')
